...
pub(super) fn message_attribute(source: &str) -> Option<(&'static str, &'static str)> {
    match source {
        ...
        "Download" => Some(("common", "download")),
        "Embed Image (in drawing)" => Some(("insert", "embed-image-in-drawing")),
        "FONT  Downloaded {name} → {path}" => Some(("insert", "font-downloaded-name-path")),
        "FONT  {old} → txt (style '{style}')" => Some(("insert", "font-old-txt-style-style")),
        "Font download failed: {e}" => Some(("insert", "font-download-failed-e")),
        "Font source — leave empty for the community repository, or point at any folder (e.g. your company's font server):" => Some(("common", "font-source-leave-empty-for-the-community-repository-or-point-at-any-folder-e-g-your-company-s-font-server")),
        "Geometric" => Some(("common", "geometric")),
        "Hide All" => Some(("common", "hide-all")),
        "IMAGEEMBED  \"{name}\": {w}×{h} px (embedded)" => Some(("insert", "imageembed-name-w-h-px-embedded")),
        "IMAGEEMBED: {e}" => Some(("insert", "imageembed-e")),
        "Missing fonts" => Some(("common", "missing-fonts")),
        "None of the missing fonts are in the community repository yet. Contribute them at github.com/huaninstratech/OpenCADStudio/tree/main/fonts." => Some(("insert", "none-of-the-missing-fonts-are-in-the-community-repository-yet")),
        "Parameters Manager" => Some(("common", "parameters-manager")),
        "Save and reopen the drawing to apply the new fonts." => Some(("insert", "save-and-reopen-the-drawing-to-apply-the-new-fonts")),
        ...
        "ANNOSCALEMODEL  new value [ON/OFF]:" => Some(("view", "annoscalemodel-new-value-on-off")),
        "ANNOSCALEMODEL: enter ON or OFF." => Some(("view", "annoscalemodel-enter-on-or-off")),
        ...
        "Annotation Scale in Model Space" => Some(("view", "annotation-scale-in-model-space")),
        "Annotation Scaling" => Some(("annotate", "annotation-scaling")),
        "Annotation scale" => Some(("properties", "annotation-scale")),
        "Annotation scale in model space: OFF" => Some(("view", "annotation-scale-in-model-space-off")),
        "Annotation scale in model space: ON" => Some(("view", "annotation-scale-in-model-space-on")),
        ...
        "This drawing uses fonts that are not installed on this machine. Download them from the OpenCADStudio community font repository?" => Some(("common", "this-drawing-uses-fonts-that-are-not-installed-on-this-machine-download-them-from-the-open-cad-studio-community-font-repository")),
        ...
        "https://server/fonts or a GitHub raw folder" => Some(("common", "https-server-fonts-or-a-github-raw-folder")),
        ...
        "Usage: QSELECT TYPE|LAYER|COLOR|LINETYPE|ANNOTATIVE <value>" => Some(("inquiry", "usage-qselect-type-layer-color-linetype-value")),
        "QSELECT ANNOTATIVE: enter YES or NO." => Some(("inquiry", "qselect-annotative-enter-yes-or-no")),
        "Apply the annotation scale in model space (annotative objects scale as drawn)" => Some(("common", "apply-the-annotation-scale-in-model-space")),
